...
export default function ScrollExpandHero({
  ...
  const advance = useCallback((delta: number) => {
    ...
    pRef.current = next;
    spring.set(next);
    if (next >= 0.96 && lockedRef.current) {
      lockedRef.current = false;
      setExpanded(true);
      document.body.style.overflow = '';
    }
  ...
  // Responsive portrait dimensions tailored for mobile & desktop
  const cardW = isMobile ? Math.min(windowSize.width * 0.68, 270) : 380;
  const cardH = isMobile ? Math.min(windowSize.height * 0.40, 360) : 530;
  const maxW = isMobile ? windowSize.width : Math.min(windowSize.width * 0.88, 560);
  const maxH = isMobile ? windowSize.height : Math.min(windowSize.height * 0.88, 780);
  ...
  return (
    <div style={{ position: 'relative', background: '#0E0D0B', minHeight: '100svh' }}>
      ...
      >
        ...
        <div
          style={{
            ...
            height: isMobile ? '460px' : '680px',
            borderRadius: '50%',
            background: 'radial-gradient(ellipse at 50% 50%, rgba(200, 130, 10, 0.18) 0%, rgba(200, 130, 10, 0.05) 45%, transparent 70%)',
            filter: 'blur(45px)',
          }}
        />
        ...
        <div
          style={{
            ...
            borderRadius: '30px',
            background: 'radial-gradient(circle, rgba(212, 150, 15, 0.12) 0%, transparent 65%)',
            filter: 'blur(30px)',
          }}
        />
      ...
      {/* ─── Hero Text Presentation (Desktop 3-Zone OR Mobile Vertical Stack) ─── */}
      {isMobile ? (
        /* 📱 MOBILE VIEWPORT CONTAINER: Headline at top, Photo in middle, CTAs at bottom */
        <div
          style={{
            position: 'fixed',
            inset: 0,
        ...
        >
          ...
          >
            ...
            >
              <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '0.62rem', fontWeight: 600, color: AMBER_ACCENT }}>
                01
              </span>
              <span style={{ width: 16, height: 1.5, background: AMBER_ACCENT, display: 'inline-block' }} />
              <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '0.62rem', color: '#F5EFE0', letterSpacing: '0.14em', textTransform: 'uppercase', fontWeight: 600 }}>
          ...
          {/* Middle Spacer: Exact gap where fixed portrait sits */}
          <div style={{ flex: 1, minHeight: '20px' }} />

          {/* Bottom section: Bio & Action buttons */}
          <motion.div
            style={{
              y: v * 40,
              textAlign: 'center',
          ...
          >
            ...
            >
              I turn complex problems into <span style={{ color: '#E8E1D5', fontWeight: 500 }}>real-world software</span> — from AI systems to full-stack products.
            </p>

            <div style={{ display: 'flex', gap: '0.65rem', justifyContent: 'center', width: '100%', maxWidth: '340px' }}>
              <a
                href="#work"
                onClick={(e) => {
                  e.preventDefault();
                ...
                style={{
                  ...
                  borderRadius: '6px',
                  textDecoration: 'none',
                  boxShadow: '0 4px 16px rgba(212, 150, 15, 0.3)',
                }}
              >
                VIEW WORK →
              </a>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.45rem', marginTop: '0.2rem' }}>
              ...
              <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '0.52rem', color: 'rgba(245, 239, 224, 0.6)', letterSpacing: '0.18em', textTransform: 'uppercase', fontWeight: 600 }}>
        ...
        /* 🖥️ DESKTOP 3-ZONE VIEWPORT GRID CONTAINER */
        <div
          style={{
            position: 'fixed',
            top: 0,
      ...
      {/* ─── Layered Portrait Presentation (Both Mobile & Desktop) ─── */}
      <div
        style={{
          position: 'fixed',
          top: '50%',
      ...
      >
        ...
        <div
          style={{
            ...
            transform: isMobile ? 'rotate(-2.5deg)' : 'rotate(-3.5deg)',
        ...
        >
          ...
          >
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: isMobile ? '0.55rem' : '0.62rem', color: '#F5EFE0', letterSpacing: '0.18em', fontWeight: 600, lineHeight: 1.2 }}>
              PRANIT
            </span>
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: isMobile ? '0.55rem' : '0.62rem', color: '#F5EFE0', letterSpacing: '0.18em', fontWeight: 600, lineHeight: 1.2 }}>
              KUMAR
          ...
          >
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: isMobile ? '0.55rem' : '0.62rem', color: 'rgba(245, 239, 224, 0.75)', letterSpacing: '0.18em', fontWeight: 500 }}>
              01 / 04
            </span>
          </div>
          ...
          <div
            style={{
              position: 'absolute',
              bottom: isMobile ? '0.85rem' : '1.25rem',
              left: isMobile ? '0.85rem' : '1.25rem',
              opacity: fade,
              zIndex: 5,
              display: 'flex',
          ...
          >
            <div style={{ width: 4, height: 4, borderRadius: '50%', background: AMBER_ACCENT }} />
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: isMobile ? '0.52rem' : '0.55rem', color: 'rgba(245, 239, 224, 0.85)', letterSpacing: '0.2em', textTransform: 'uppercase', fontWeight: 500 }}>
              BENGALURU, INDIA
            </span>
          </div>
        </div>
